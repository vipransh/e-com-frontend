  ...
  return (
    <div className='font-poppins bg-white  h-screen flex flex-col  antialiased'>
      ...
      <div className='flex flex-col items-center mt-4 border-b p-2 border-gray-400 '>
        ...
        <h3 className='font-bold'>Vipransh</h3>
        <h4 className='text-xs'>Administrator</h4>
      </div>
      <Link to={"/dashboard"}>
      ...
      <Link to={"/dashboard/category&coupons"}>
      ...
      <BsTagsFill size={20}/>
      <h3 className='font-bold ml-3'>Category & Coupons</h3></div>
      </Link>
